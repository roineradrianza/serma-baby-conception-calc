...
new SERMA_BABY_AGE_CONCEPTION_CALC_SHORTCODE();

class SERMA_BABY_AGE_CONCEPTION_CALC_SHORTCODE
{

    public function __construct()
    {
        add_shortcode('serma-baby-conception-wp', array($this, 'conception_calc'));
    }

    public function conception_calc($attrs = [])
    {
        ...
        if (!is_admin()) {
            ...
            wp_register_script( 'moment', SERMA_BABY_CONCEPTION_URL . "assets/js/lib/moment.min.js", [], '2.29.1', true );
            ...
            wp_add_inline_script( 'tailwind-css', serma_baby_conception_tailwind_config() );

            $vue_file = SERMA_BABY_CONCEPTION_ENV ? 'vue.min' : 'vue.prod.min';

            serma_baby_conception_register_script(
                "lib/$vue_file", 
                ['moment'], 
                false
            );

            return SERMA_BABY_CONCEPTION_TEMPLATE::render_view(
                [], 
                [
