    ...
    <div class="grid grid-cols-1 md:grid-cols-8">
        <div class="hidden md:inline col-span-3 px-3 md:px-3 pt-6 pb-4 bg-cover"
            ...
            <img class="pb-3 max-w-[208px] mx-auto"
                src="<?= SERMA_BABY_CONCEPTION_URL ?>/assets/img/gestational-age-bg.png">
        </div>
        ...
        <div class="bg-[#62cef933] md:col-span-5 p-3 md:p-6 rounded-2xl">
            <form method="post">
                ...
                <div class="grid grid-cols-5 mb-4">
                    ...
                    <div class="col-span-2 relative">
                        ...
                        <div class="flex absolute inset-y-0 right-0 items-center pl-3 pointer-events-none">
                            <img class="w-[20px] mr-2"
                                src="<?= SERMA_BABY_CONCEPTION_URL ?>/assets/icons/calendar.svg">
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-5 mb-4">
                    <div class="col-span-3 flex items-center">
                        <img class="w-[20px] mr-2"
                            src="<?= SERMA_BABY_CONCEPTION_URL ?>/assets/icons/gestational-age/duration.svg">
                        <label class="text-secondary text-13px md:text-14px" for="">
                            Duración del ciclo
                        </label>
                    </div>
...
<?= SERMA_BABY_CONCEPTION_TEMPLATE::show_template('gestational-calc/form/results') ?>